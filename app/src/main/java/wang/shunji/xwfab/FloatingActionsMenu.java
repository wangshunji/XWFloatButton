...
public class FloatingActionsMenu extends ViewGroup {
    ...
    //设置半透明背景
    public void setBgView(View bg_view) {
        this.bgView = bg_view;
    ...
    public void setbackgroundAlph(Window window) {
        this.window = window;
    }
...
//      backgroundAlpha(0.5f);
    ...
    private View getBgView(boolean b) {
        ViewGroup root = (ViewGroup) getRootView();
        RelativeLayout rootView = new RelativeLayout(getContext());
        RelativeLayout topBgview = new RelativeLayout(getContext());
        RelativeLayout bottomBgview = new RelativeLayout(getContext());

        RelativeLayout.LayoutParams rlp = new RelativeLayout.LayoutParams(RelativeLayout.LayoutParams.MATCH_PARENT, LinearLayout.LayoutParams.MATCH_PARENT);
        RelativeLayout.LayoutParams tlp = new RelativeLayout.LayoutParams(RelativeLayout.LayoutParams.MATCH_PARENT, dp2px(20));
        RelativeLayout.LayoutParams blp = new RelativeLayout.LayoutParams(RelativeLayout.LayoutParams.MATCH_PARENT, dp2px(40));

        rootView.setLayoutParams(rlp);

        topBgview.setLayoutParams(tlp);
        tlp.addRule(RelativeLayout.ALIGN_PARENT_TOP);
        topBgview.setBackgroundColor(getColor(R.color.blue_semi_transparent));


        bottomBgview.setLayoutParams(blp);
        blp.addRule(RelativeLayout.ALIGN_PARENT_BOTTOM);
        bottomBgview.setBackgroundColor(getColor(R.color.blue_semi_transparent));

        rootView.addView(topBgview);
        rootView.addView(bottomBgview);
        rootView.setId(R.id.fab_bg_view);
        RelativeLayout layout = root.findViewById(R.id.fab_bg_view);
        ...
        if (b) {
            ...
            if (layout == null) {
                ...
                topBgview.setOnClickListener(new OnClickListener() {
                    @Override
                    public void onClick(View v) {
                    }
                });
                bottomBgview.setOnClickListener(new OnClickListener() {
                    @Override
                    public void onClick(View v) {
                    }
                });
